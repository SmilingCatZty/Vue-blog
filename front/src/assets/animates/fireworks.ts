...
interface FireConfigModel {
  enable: boolean
  fireworks: string[]
}

const FireConfig: FireConfigModel = {
  enable: true,
...
const canvasEl = document.createElement('canvas') as any
...
// 从配置文件中获取烟花的颜色
const colors = FireConfig.fireworks
...
export function initFireworks() {
  if (typeof FireConfig.fireworks === 'undefined') {
    return
  }
